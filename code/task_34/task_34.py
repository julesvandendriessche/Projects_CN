...
def plot(update, title, xlabel,alpha1, alpha2, iterations = 2,N =3, rowsX = 20, intervalB = 0.1,mean = 2):
    ...
    save_results_to = 'code/task_34/output/'
    plt.savefig(save_results_to + '34_'+ title + '_' + str(alpha1) +'_' + str(alpha2) +  '.png', dpi = 300)
...
def compare_final_strat(iterations = 10 , N = 10, mean = 1, bins = 20, P =  [0.03,0.05,0.202]):
    ...
    for p in range(3):
        ...
        fig.tight_layout()
    save_results_to = 'code/task_34/output/'
    plt.savefig(save_results_to + '34_soc' + str(P) + '.png', dpi = 300)
